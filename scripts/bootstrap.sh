...
say "Seed memory"
bd remember "This repo uses the BMAD×beads bridge: AGENTS.md is the protocol; scripts/bmad_beads.py {import,sync,status,doctor}." --key bmad-beads-bridge >/dev/null 2>&1 || true
